...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $_POST['cin'] = trim($_POST['cin']);
    $_POST['dateNaiss'] = trim($_POST['dateNaiss']);
    $_POST['mail'] = trim($_POST['mail']);
    if (!empty($_POST['login']) && !empty($_POST['nom']) && !empty($_POST['cin']) && !empty($_POST['dateNaiss']) && !empty($_POST['mail']) && !empty($_POST['passwd']) && !empty($_POST['passwd2'])) {
